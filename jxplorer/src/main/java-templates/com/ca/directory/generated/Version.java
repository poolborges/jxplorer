package com.ca.directory.generated;
...
public class Version implements Serializable {
     ...
     * BUILD SMC Time
     */
    private static final String BUILD_SCMDATE;
    ...
    static {
        ...
        BUILD_SCMDATE = "${artifact.build.scmbuildtime}";
    }
    ...
    public static String getBuildScmTime() {
        return BUILD_SCMDATE;
    }
    
    public static String getFullVersionWithMeta() {
        return VERSION_FULL +"; Date: "+BUILD_SCMDATE +"; buildno: "+BUILD_NUMBER;
    }
